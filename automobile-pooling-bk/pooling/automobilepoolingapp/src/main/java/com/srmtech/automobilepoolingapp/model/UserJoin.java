...
public class UserJoin implements Serializable{
    ...
    public UserJoin(Long id, String firstname, String lastname, String designation, String source, String destination, String stopa, String stopb, Boolean availabilitystatus, String vehiclenumber, String vehiclecolor, String vehicletype, Integer numberofseats, Long ridecount) {
        this.id = id;
        this.firstname = firstname;
        this.lastname = lastname;
        this.designation = designation;

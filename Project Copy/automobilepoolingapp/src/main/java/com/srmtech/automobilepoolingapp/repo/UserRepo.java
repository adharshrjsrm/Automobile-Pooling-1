...
public interface UserRepo extends JpaRepository<User, Long> {
    ...
    @Query("select new com.srmtech.automobilepoolingapp.model.UserJoin(u.id,u.firstname,u.lastname,u.designation,u.source,u.destination,u.stopa,u.stopb,u.mobile,"+
    ...
    @Query("select count(id)=0 from  com.srmtech.automobilepoolingapp.model.User where user_details_id=?1 and vehicle_id=null")
    Boolean existByVehicle(Long userid);

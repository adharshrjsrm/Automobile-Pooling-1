...
public class ApiController extends BaseController {
    ...
    @PreAuthorize("isAuthenticated()")
    @GetMapping(value = "/existvehicle")
    public  boolean existByVehicle(){
        Long userid=getUserId();
        Boolean user = userservice.existByVehicle(userid);
        return user;
    }
    ...
    @PreAuthorize("isAuthenticated()")
    @GetMapping(value = "/getpassengerride")
    public ResponseEntity<List<Ride>> findPassengerRide() throws ResourceNotFoundException {
        Long userid=getUserId();
        Long userId = userservice.getUserIdRide(userid);
        List<Ride> rideList = rideservice.getPassengerRideDetails(userId);
        return new ResponseEntity<>(rideList, HttpStatus.OK);
    }
    @PreAuthorize("isAuthenticated()")
    ...
    @PreAuthorize("isAuthenticated()")
    @GetMapping(value = "/passengerride")
    public ResponseEntity<List<Ride>> findPassengerRides() throws ResourceNotFoundException {
        Long userid=getUserId();
        Long userId = userservice.getUserIdRide(userid);
        List<Ride> rideList = rideservice.getUserRide(userId);
        return new ResponseEntity<>(rideList, HttpStatus.OK);
    }

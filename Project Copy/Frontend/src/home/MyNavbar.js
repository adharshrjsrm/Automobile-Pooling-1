                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        <Nav className="mr-auto">
                            ...
                            <NavDropdown  title="Login" id="responsive-nav-dropdown">
                                <NavDropdown.Item id="nav-dd-item" onClick={handleOShow}>Owner</NavDropdown.Item>
                                <NavDropdown.Item id="nav-dd-item" onClick={handlePShow}>Passenger</NavDropdown.Item>
                            </NavDropdown>
                        </Nav>
                    </Navbar.Collapse>
                </Navbar>
